...
<nav class="navbar navbar-default navbar-inverse" style="z-index:10" role="navigation">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Where Dreams are Made <span
                            class="caret"></span></a>
                ...
                <li class="dropdown">
                    ...
                    <ul id="login-dp" class="dropdown-menu" role="menu">
                        ...
                        %>
                        <li><a href="${pageContext.request.contextPath}/register">New here? Join Us</a></li>
                    </ul>
